...
SECRET_KEY = 'drz%fdt_9xj*$z17&2)@v9&q)o$p=$$zl5-f%sg(28cqz(#u!7'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'Group11','templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_POST = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'team11.2021@gmail.com'
EMAIL_HOST_PASSWORD = 'Abedabed123'
